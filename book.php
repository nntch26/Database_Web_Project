...
// hotel facility 
$select_stmt2 = $db->prepare("SELECT facility_name FROM hotels h 
                              JOIN hotelsfacility h2 USING (hotel_id) 
                              JOIN facilityname USING (facility_id)  WHERE hotel_id = :hotel_id");
