    ...
    <div class="container">
        <div class="row">
            ...
            <form class="p-5 card" action="BackEnd/insertroom_db.php" method="post" enctype="multipart/form-data">
                ...
                <?php if (isset($_SESSION['err_insertroom'])) : ?>
                    <!-- ถ้ามี error ให้แสดง alert  ถ้าเป็นข้อมูลว่าง แสดงข้อความเตือน-->
                    <div class="alert alert-danger" role="alert">
                        <?php echo $_SESSION['err_insertroom']; ?>
                    </div>
                <?php endif; ?>
...
if (isset($_SESSION['err_insertroom']) || isset($_SESSION['err_roominsert']) || isset($_SESSION['is_room'])) {
    unset($_SESSION['err_insertroom']);
